...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('blogs')->group(function(){
        ...
        Route::get('/view',[BlogController::class, 'AllBlogs'])->name('admin.blog.view');    
        Route::get('/add',[BlogController::class, 'AddBlogs'])->name('admin.blog.add');
        Route::post('/store',[BlogController::class, 'StoreBlogs'])->name('admin.blog.store');
        Route::get('/edit/{id}',[BlogController::class, 'EditBlogs'])->name('admin.blog.edit');
        Route::post('/update/{id}',[BlogController::class, 'UpdateBlogs'])->name('admin.blog.update');
        Route::get('/delete/{id}',[BlogController::class, 'DeleteBlogs'])->name('admin.blog.delete'); 
        
    });

    //Contact Form View
    Route::get('contact/form/view',[ContactController::class, 'ContactForm'])->name('admin.contact-form.view');    
    Route::get('delete/form/view/{id}',[ContactController::class, 'DeleteContactForm'])->name('admin.contact-form.delete');    
